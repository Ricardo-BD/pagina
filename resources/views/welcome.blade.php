...
<nav class="navbar navbar-expand-lg navbar-light bg-light pt-0">
  <div class="container-fluid" style="border-top: 1px groove">
    <a class="navbar-brand" href="#"><img src="{{ asset('resources/imgs/LOGOAIC.png') }}" alt="" width="150" height="180" class="img-fluid"></a>
...
<main>
  ...
  <!-- FOOTER -->
    <footer class="pt-4 mt-5 pt-md-5 border-top d-flex justify-content-center" style="background-color: gainsboro">
